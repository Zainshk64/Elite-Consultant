...
export default function LoginPage() {
  ...
  const benefits = [
    ...
    { icon: Users, text: "Expert Consultation Team" },
  ]
          ...
          <div className="relative hidden lg:block bg-gradient-to-br from-orange-50 via-orange-100 to-orange-200 p-12">
            ...
            <div className="relative z-10 h-full flex flex-col justify-between">
              <div>
                ...
                >
                  ...
                  <p className="text-gray-600 text-lg mb-8">
                    Continue your journey towards achieving your dreams with our expert guidance
                  </p>
                </motion.div>
              ...
              <motion.div
                ...
                animate={{ opacity: 1 }}
                transition={{ delay: 1 }}
                className="bg-white/60 mt-5 backdrop-blur-sm rounded-2xl p-6 border border-orange-200/50"
              >
                <p className="text-gray-600 text-sm mb-2">Trusted by students worldwide</p>
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    <span className="text-3xl font-bold text-[#EE7A36]">50+</span>
          ...
          <div className="p-8 md:p-12 lg:p-16 bg-white">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-orange-50 border border-[#EE7A36]/30 rounded-full mb-4">
                ...
                <span className="text-[#EE7A36] text-sm font-semibold">WELCOME BACK</span>
              </div>
            ...
            <div className="space-y-5">
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/forgot-password" className="text-sm text-[#EE7A36] hover:text-orange-600 font-semibold transition-colors">
                    Forgot?
                  </Link>
                </div>
                <div className="relative">
              ...
              >
                <input
                  ...
                  className="w-5 h-5 rounded-md border-gray-300 bg-white text-[#EE7A36] focus:ring-[#EE7A36]/20 cursor-pointer"
                />
              ...
              >
                <button className="flex items-center justify-center gap-3 py-3 px-4 border-2 border-gray-300 rounded-xl hover:border-[#EE7A36] hover:bg-orange-50 transition-all group">
                  ...
                  <span className="text-gray-700 font-medium group-hover:text-[#EE7A36] transition-colors">Google</span>
                </button>
                <button className="flex items-center justify-center gap-3 py-3 px-4 border-2 border-gray-300 rounded-xl hover:border-[#EE7A36] hover:bg-orange-50 transition-all group">
                  <svg className="w-5 h-5" fill="#1877F2" viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                  </svg>
                  <span className="text-gray-700 font-medium group-hover:text-[#EE7A36] transition-colors">Facebook</span>
                </button>
              </motion.div>
              ...
              >
                ...
                <Link href="/register" className="text-[#EE7A36] hover:text-orange-600 font-semibold transition-colors">
                  Create account
                </Link>
              </motion.p>
            </div>
