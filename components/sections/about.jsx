  ...
  return (
    <section className="py-42 pb-16 bg-background transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-bold mb-4 text-balance">About H&H Consultant</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            <p className="text-gray-400 text-lg mb-4">
              Founded in 2014, H&H Consultant has been committed to transforming dreams into reality for thousands of
